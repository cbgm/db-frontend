define({
	"head_text" : "&quotSie fragen sich wer hinter dieser Website steckt?&quot",
	"shortdescription_text" : "Gut, dass Sie nachfragen! Ich bin die Art von Person, die für Träume zu kämpfen hatte. Ich bin ein komplexer Mensch, der die Herausforderung im Leben braucht. Darin spiegelt sich auch die Vielfalt der Dinge wieder, in die ich interessiert bin, wie zum Beispiel:",
	"shortdescription2_text" : "Ich bin nicht nur an vielen Dingen interessiert, sondern habe zudem noch eine <a href='#academic_career'><i>akademische Laufbahn</i></a> vorzuweisen.",
	...
	"keyboard_text" : "Im Alter von 7 Jahren habe ich durch den Einfluss meines Opas angefangen Keyboard zu spielen ;), habe das aber nie bereut. " +
						"Seit dem macht mir das Spaß und meine spielerischen Qualitäten haben sich ausgebaut und in Richtung Piano-Play geändert. " +
						"Ich liebe es Stücke von Evanescence oder Whitin Temptation zu spielen, allgemein Balladen haben es mir angetan. " +
						"In meiner Hinsicht sind diese besonders und stechen in der Flut von Songs immer wieder heraus.",
	...
	"bachelor_button_text" : "&#9654; Bachelor Urkunde",
	"master_button_text" : "&#9654; Master Urkunde",
	...
	"anker" : "" +
				"<ul class='taglist'>" +
					"<li><a href='#extreme_sports'>#Extremsport</a></li>" +
					"<li><a href='#skateboarding'>#Skateboarden</a></li>" +
					"<li><a href='#snowboarding'>#Snowboarden</a></li>" +
					"<li><a href='#music'>#Musik</a></li>" +
					"<li><a href='#keyboard'>#Keyboard</a></li>" +
					"<li><a href='#drums'>#Schlagzeug</a></li>" +
					"<li><a href='#technology'>#Technologien</a></li>" +
					"<li><a href='#programming'>#Programmieren</a></li>" +
					"<li><a href='#design'>#Design</a></li>" +
					"<li><a href='#filming'>#Filmen</a></li>" +
					"<li><a href='#editing'>#Editieren</a></li>" +
